...
public class condExpBeginStatement extends statement{
	...
	public List<FlowLineNode<CSFlowLineData>> HandleCodeSynthesis(CSFlowLineQueue squeue, CSStatementHandler smthandler)
		...
		result.add(new FlowLineNode<CSFlowLineData>(new CSFlowLineData(squeue.GenerateNewNodeId()+"", smthandler.getSete(), "", null, null, squeue.GetLastHandler(), new CSCondExpBeginProperty()), smthandler.getProb()));
		return result;
	}

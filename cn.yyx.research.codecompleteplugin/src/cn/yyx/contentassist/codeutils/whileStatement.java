...
public class whileStatement extends statement{
	...
	public List<FlowLineNode<CSFlowLineData>> HandleCodeSynthesis(CSFlowLineQueue squeue, CSStatementHandler smthandler)
		...
		return CSFlowLineTypeCheckRefiner.RetainTheFallThroughFlowLineNodes(CSFlowLineHelper.ConcateOneFlowLineList("while (", rels, ") " + CodeSynthesisHelper.GenerateBlockCode(smthandler)), new CCType(Boolean.class, "Boolean"));

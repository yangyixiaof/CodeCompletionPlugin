...
public class variableDeclarationHolderStatement extends statement{
	...
	public List<FlowLineNode<CSFlowLineData>> HandleCodeSynthesis(CSFlowLineQueue squeue, CSStatementHandler smthandler)
		...
		{
			modified = GetModifiedName(squeue, smthandler, typecode, name);
			result.add(new FlowLineNode<CSFlowLineData>(new CSVariableHolderData(modified, false, squeue.GenerateNewNodeId(), smthandler.getSete(), " "+modified, null, null, squeue.GetLastHandler()), smthandler.getProb()));
		}
		if (modified == null)
		{

...
public class returnStatement extends statement{
	...
	public List<FlowLineNode<CSFlowLineData>> HandleCodeSynthesis(CSFlowLineQueue squeue, CSStatementHandler smthandler)
		...
		else
		{
			...
			result.add(new FlowLineNode<CSFlowLineData>(new CSFlowLineData(squeue.GenerateNewNodeId(), smthandler.getSete(), "return;", null, false, false, null, squeue.GetLastHandler()), smthandler.getProb()));
			return result;
		}
	}

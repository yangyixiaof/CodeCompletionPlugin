...
public class enterMethodParamStatement extends statement{
	...
	public List<FlowLineNode<CSFlowLineData>> HandleCodeSynthesis(CSFlowLineQueue squeue, CSStatementHandler smthandler)
		...
		result.add(new FlowLineNode<CSFlowLineData>(new CSFlowLineData(squeue.GenerateNewNodeId()+"", smthandler.getSete(), "", null, false, true, null, squeue.GetLastHandler(), new CSEnterParamInfoProperty(times)), smthandler.getProb()));
		return result;
	}

...
public class condExpColonMarkStatement extends statement{
	...
	public List<FlowLineNode<CSFlowLineData>> HandleCodeSynthesis(CSFlowLineQueue squeue, CSStatementHandler smthandler)
		...
		result.add(new FlowLineNode<CSFlowLineData>(new CSFlowLineData(squeue.GenerateNewNodeId()+"", smthandler.getSete(), ":", null, null, squeue.GetLastHandler(), new CSCondExpColonMarkProperty(null)), smthandler.getProb()));
		return result;
	}

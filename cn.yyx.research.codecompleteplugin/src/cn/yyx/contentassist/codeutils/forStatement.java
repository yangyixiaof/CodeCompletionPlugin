...
public class forStatement extends statement{
	...
	public List<FlowLineNode<CSFlowLineData>> HandleCodeSynthesis(CSFlowLineQueue squeue, CSStatementHandler smthandler)
		...
		result.add(new FlowLineNode<CSFlowLineData>(new CSFlowLineData(squeue.GenerateNewNodeId() + "", smthandler.getSete(), "for (", null, true, true, null, null, squeue.GetLastHandler(), new CSForProperty()), smthandler.getProb()));
		return result;
	}

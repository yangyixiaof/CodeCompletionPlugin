...
public class integerLiteral extends numberLiteral{
	...
	public List<FlowLineNode<CSFlowLineData>> HandleCodeSynthesis(CSFlowLineQueue squeue, CSStatementHandler smthandler)
		...
		result.add(new FlowLineNode<CSFlowLineData>(new CSFlowLineData(squeue.GenerateNewNodeId(), smthandler.getSete(), getValue()+"", new CCType(int.class, "int"), false, false, null, squeue.GetLastHandler()), smthandler.getProb()));
		return result;
	}

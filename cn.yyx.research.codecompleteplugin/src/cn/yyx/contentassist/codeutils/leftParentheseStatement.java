...
public class leftParentheseStatement extends statement{
	...
	public List<FlowLineNode<CSFlowLineData>> HandleCodeSynthesis(CSFlowLineQueue squeue, CSStatementHandler smthandler)
		...
		result.add(new FlowLineNode<CSFlowLineData>(new CSFlowLineData(squeue.GenerateNewNodeId() + "", smthandler.getSete(), StringUtil.GenerateDuplicates("(", times), null, true, true, null, squeue.GetLastHandler(), new CSLeftParenInfoProperty(times)), smthandler.getProb()));
		return result;
	}
